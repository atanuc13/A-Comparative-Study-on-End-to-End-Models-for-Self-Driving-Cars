...
filepath="hd5/VGG16_final_oscar.hdf5"
checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=1, save_best_only=True, mode='min')
callbacks_list = [checkpoint]

history = parallel_model.fit(X_train, Y_train, epochs=100, validation_data=(X_valid, Y_valid), batch_size=32, verbose=1, shuffle=1, callbacks=callbacks_list)
...
plt.savefig('plots/vgg16_Final_oscar.png', dpi=300, bbox_inches='tight')
plt.show()
