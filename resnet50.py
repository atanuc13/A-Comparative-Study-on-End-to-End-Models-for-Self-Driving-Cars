...
columns = ["img","steering"]
data = pd.read_csv(r'/home/choyya/data_ABIDA/driving1.csv', names = columns)
datadir = '/home/choyya/data_ABIDA/data'
...
#from keras.applications import VGG119
#Load the ResNet50 model
from tensorflow.keras.applications.resnet50 import ResNet50
vgg16 = ResNet50(weights='imagenet', include_top=False, input_shape=(66, 200, 3))
...
filepath="hdf5/resnet50_udacity.hdf5"
...
plt.savefig('plots/resnet50_udacity.png', dpi=300, bbox_inches='tight')
plt.show()
